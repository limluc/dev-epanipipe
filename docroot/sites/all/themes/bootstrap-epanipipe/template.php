 ...
 * Page alter.
 */
function bootstrap_epanipipe_page_alter($page) {
 ...
 */
function bootstrap_epanipipe_preprocess_html(&$variables) {
	/**
	 * Add IE8 Support
	 */
	...
	*/
	if (theme_get_setting('bootstrap_js_include', 'bootstrap_epanipipe')) {
	drupal_add_js(drupal_get_path('theme', 'bootstrap_epanipipe') . '/bootstrap/js/bootstrap.min.js');
	}
	//EOF:Javascript
	...
	*/
	if (theme_get_setting('scrolltop_display', 'bootstrap_epanipipe')) {
 ...
 */
function bootstrap_epanipipe_process_html(&$vars) {
 ...
 */
function bootstrap_epanipipe_preprocess_page(&$vars) {
 ...
 */
function bootstrap_epanipipe_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function bootstrap_epanipipe_preprocess_block(&$variables) {
 ...
 */
function bootstrap_epanipipe_breadcrumb($variables) {
 ...
 */
function bootstrap_epanipipe_form_alter(&$form, &$form_state, $form_id) {
