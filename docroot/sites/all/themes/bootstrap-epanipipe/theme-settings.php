 ...
 *   The form state.
 */
function bootstrap_epanipipe_form_system_theme_settings_alter(&$form, &$form_state) {
    
    $form['mtt_settings'] = array(
        '#type' => 'fieldset',
        '#title' => t('Bootstrap ePanipipe Theme Settings'),
        '#collapsible' => FALSE,
        '#collapsed' => FALSE,
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['breadcrumb_display'] = array(
        ...
        '#default_value' => theme_get_setting('breadcrumb_display','bootstrap_epanipipe'),
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
        ...
        '#default_value' => theme_get_setting('scrolltop_display', 'bootstrap_epanipipe'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['bootstrap_js_include'] = array(
        ...
        '#default_value' => theme_get_setting('bootstrap_js_include', 'bootstrap_epanipipe'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['mtt_settings']['tabs']['ie8_support']['responsive_respond'] = array(
        '#type' => 'checkbox',
        '#title' => t('Add Respond.js [<em>bootstrap-ePanipipe/js/respond.min.js</em>] JavaScript to add basic CSS3 media query support to IE 6-8.'),
        '#default_value' => theme_get_setting('responsive_respond','bootstrap_epanipipe'),
