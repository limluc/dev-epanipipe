...
class LinkitSearchPluginEntity extends LinkitSearchPlugin {
  ...
  public function fetchResults($search_string) {
    ...
    if (module_exists('title')) {
      $this->query->fieldCondition('title_field', 'value',  '%' . db_like($search_string) . '%', 'LIKE', NULL, 'group');
      $this->query->fieldLanguageCondition('title_field', $language->language, '=', NULL, 'group');
    }
    else {
    ...
    $this->query->addTag('linkit_' . $this->plugin['entity_type'] . '_autocomplete');
